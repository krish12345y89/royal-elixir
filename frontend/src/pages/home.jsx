    ...
    <div className="skincare-hub">
      ...
      <header className="header">
        <div className="container">
          <div className="nav-bar">
            <div className="logo">
              <svg className="crown small" viewBox="0 0 24 16" aria-hidden="true" focusable="false">
      ...
      <section className="hero">
        <div className="container">
          <div className="hero-content">
            ...
            <p>Discover personalized skincare solutions, expert advice, and premium products tailored to your unique skin needs.</p>
        ...
        <div className="container">
          <div className="section-header">
            ...
            <div className="product-filters">
              {['all', 'cleanser', 'serum', 'moisturizer', 'sunscreen'].map(category => (
                <button
                  key={category}
      ...
      <section className="routine-builder" id="routines">
        <div className="container">
          ...
          <p>Follow our step-by-step guide to create a routine that works for you</p>
          <div className="routine-steps">
            {[
              { step: 1, title: 'Cleanse', desc: 'Remove impurities and makeup' },
      ...
      <section className="newsletter">
        <div className="container">
          <div className="newsletter-content">
            ...
            <p>Subscribe to our newsletter for expert advice and special discounts</p>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-section">
              <div className="logo">
                <svg className="crown" viewBox="0 0 24 16" aria-hidden="true" focusable="false">
                  <path d="M1 13c0 .6.4 1 1 1h20c.6 0 1-.4 1-1V5c0-.6-.4-1-1-1-.2 0-.4.1-.6.2L16 9 12 3 8 9 1.6 4.2C1.4 4.1 1.2 4 1 4 0.4 4 0 4.4 0 5v8z" />
                </svg>
                <i className="fas fa-spa"></i>
                <span>Skincare Hub</span>
              </div>
              <p>Your trusted partner in skincare journey. Quality products, expert advice, and personalized routines.</p>
          ...
          <div className="footer-bottom">
            <p className="footer-copyright">&copy; 2024 Skincare Hub. All rights reserved.</p>
